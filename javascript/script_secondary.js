function mobileMenuShow() {
    ...
    if (x.classList.contains("mobile-menu-show")) {
        ...
        if (offsetY <= 20) {
            ...
            setTimeout(function () {
                for (i = 0; i < hamburger.length; i++) {
                    hamburger[i].classList.remove("black-background")
                    hamburger[i].classList.add("white-background")
                }
        ...
        for (i = 0; i < hamburger.length; i++) {
            hamburger[i].classList.remove("white-background")
            hamburger[i].classList.add("black-background")
        }
